/* autogenerated by Processing revision 1295 on 2025-02-13 */
...
public class Assignment_Tracker extends PApplet {
...
public int daysUntilDue(Assignment a){
  String[] monthDay = split(a.dueDate, '/');
  Calendar due = Calendar.getInstance();
  due.set(Calendar.MONTH, PApplet.parseInt(monthDay[0]) - 1);
  due.set(Calendar.DATE, PApplet.parseInt(monthDay[1]));
  due.set(Calendar.YEAR, year());
  Calendar now = Calendar.getInstance();
  long diff = due.getTimeInMillis() - now.getTimeInMillis();
  return PApplet.parseInt(diff / (1000 * 60 * 60 * 24));
}
public void drawAssignmentList() {
  int y = 150;
...
public void drawErrorMessage() {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Assignment_Tracker" };
    if (passedArgs != null) {
